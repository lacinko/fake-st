...
function Modal({ children, buttonText }: ModalProps) {
  return (
    <>
      <button
        type="button"
      ...
      >
        <div className="m-3 mt-0 opacity-0 transition-all ease-out hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 lg:mx-auto lg:w-full lg:max-w-4xl">
