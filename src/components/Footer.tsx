          ...
          <div className="col-span-2">
            ...
            <form>
              <div className="mt-4 flex flex-col items-center gap-2 rounded-md bg-white p-2 sm:flex-row sm:gap-3">
                ...
                <a
                  className="inline-flex w-full items-center justify-center gap-x-3 whitespace-nowrap rounded-md border border-transparent bg-blue-500 px-4 py-3 text-center font-medium text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white sm:w-auto"
                  href="#"
                >
                  Subscribe
                </a>
              ...
              <p className="mt-3 text-sm text-gray-800">
                Never miss any new products and offers.
              </p>
            </form>
          </div>
        </div>
        ...
        <div className="mt-5 grid gap-y-2 sm:mt-12 sm:flex sm:items-center sm:justify-between sm:gap-y-0">
          <div className="flex items-center justify-between">
            <p className="text-sm text-gray-800">
              © 2023 Fake store inc. All rights reserved.
            </p>
          </div>

          <div>
            <a
              className="inline-flex h-10 w-10 items-center justify-center gap-x-3.5 rounded-md text-center text-gray-950 transition hover:bg-white/[.1] focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-gray-900"
              href="#"
            >
              <svg
                className="h-4 w-4"
